import type { CompanyProofStatus } from '../../organization-network/domain/organization-network.js';
...
export type MoneyTrackerSummary = {
  ...
  outgoingPaymentInstructionStatus: 'notStarted' | 'pending' | 'settlementInstructionReady' | 'settled' | 'failed';
  incomingReceivableStatus: 'notStarted' | 'pending' | 'metadataReady' | 'settled' | 'failed';
  budgetLimit: string;
